...
public class HtmlSaver {
    public String welcomeMail(String username) {
        return "<!doctype html>\n" +
                ...
                "                            style=\"font-size: 24px;\"><strong>Bienvenido, " + username + " :)</strong></span></p>\n" +
                "                        <p style=\"text-align: center;\">&nbsp;</p>\n" +
                "                        <p style=\"text-align: center;\"><span style=\"font-size: 16px;\">Te damos la bienvenida a somos mas!</span></p>\n" +
                "                      </div>\n" +
                "\n" +
                "                    </td>\n" +
                "                  </tr>\n" +
                ...
                "                      <div\n" +
                "                        style=\"font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;\">\n" +
                "                        <p style=\"text-align: center;\">Instagram: SomosMás | Facebook: Somos_Más | Teléfono de contacto: 1160112988</p>\n" +
                "                      </div>\n" +
                "\n" +
                "                    </td>\n" +
                "                  </tr>\n" +
